...
class AppStyles {
  ...
  static TextStyle get primaryTextStyle24_400 => TextStyle(
      ...
      static TextStyle get primaryTextStyle24_800 => TextStyle(
        fontSize: 24.sp,
        fontWeight: FontWeight.w800,
        color: AppColors.primaryColor,
      );
  static TextStyle get whiteTextStyle18_700 => TextStyle(
        fontSize: 18.sp,
        fontWeight: FontWeight.w400,
        color: AppColors.whiteColor,
      );
  static TextStyle get blackTextStyle18_400 => TextStyle(
        fontSize: 18.sp,
        fontWeight: FontWeight.w400,
  ...
  static TextStyle get primaryTextStyle20_400 => TextStyle(
        fontSize: 20.sp,
        fontWeight: FontWeight.w700,
        color: AppColors.primaryColor,
      );
